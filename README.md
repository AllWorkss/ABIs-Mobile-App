...
To see how much of the Android app is complete, read [`docs/BUILD_STATUS.md`](docs/BUILD_STATUS.md). To run it on Android Studio, phone, or emulator, follow [`docs/HOW_TO_VIEW_APP.md`](docs/HOW_TO_VIEW_APP.md).
